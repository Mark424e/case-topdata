  ...
  return (
    <header>
      <div className="container mx-auto ">
        <div className="relative flex justify-between items-center py-8 font-navbar z-50">
          <a
            className="font-logo tracking-widest uppercase text-3xl me-16 shrink-0"
            href="#"
          >
          ...
          <div className="relative flex-1 flex justify-end items-center h-10">
            <ul
              className={`flex items-center space-x-10 transition-all duration-300 ease-in-out [&>li>div]:bg-primary [&>li>div>a]:transition-all [&>li>div>a]:duration-200 [&>li>div>a]:ease-in-out ${
                isSearchOpen
            ...
            >
              <li className="group relative float-left hover:block">
                ...
                <div className="absolute -left-1 py-2 text-sm shadow-md shadow-primary/50 rounded min-w-max opacity-0 invisible translate-y-2 transition-all duration-200 ease-in-out group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 [&>a]:p-2 [&>a]:float-none [&>a]:block [&>a]:text-left [&>a]:hover:bg-secondary">
                  <a href="#">TOP-PRIME</a>
                  <a href="#">TOP-PERFORMANCE</a>
                  <a href="#">HIGH-LINE</a>
                  <a href="#">DESIGN-LINE</a>
                </div>
              </li>
